...
<nav class="navbar text-bg-info p-3 ">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Empresa de caminhão xd</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="registro.php">Registrar entrega</a>
        </li>
...
<div class="container rounded-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded w-50 p-3"> <form>
  <div class="row mb-3 ">
